...
export default function SOCreateForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch(`${API_URL}/product/sos/`, {
        method: 'POST',
      ...
      setErrors({ general: 'Failed to create SO. Please try again.' });
    } finally {
      setSubmitting(false);
    }
  };
