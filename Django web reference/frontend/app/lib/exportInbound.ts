...
import InboundPDF from '../ui/dashboard/InboundPDF';
import { ReactElement } from 'react';

export const exportInbound = async (products: Product[]) => {
  ...
  try {
    ...
    link.href = url;
    link.download = `Inbound_report_${formatDate(products[0].date)}.pdf`;
